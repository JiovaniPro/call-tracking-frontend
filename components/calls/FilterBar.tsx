  ...
  return (
    <div className="mb-4 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
      <div className="flex flex-1 flex-wrap items-center gap-3">
        ...
        {/* Date range */}
        <div className="flex items-center gap-1 rounded-xl border px-2 py-1.5 text-[11px] md:text-[11px]">
          <CalendarRange className="mr-1 h-3.5 w-3.5 text-slate-400" />
          {[
        ...
        {/* Call type */}
        <div className="inline-flex items-center gap-1 rounded-xl border px-2 py-1.5 text-[11px]">
          {[
            { id: "all", label: "Tous" },
